...
Route::group(array('https' => true), function(){
  ...
  Route::put('projects/(:num)/bids/(:num)', array('uses' => 'bids@update', 'as' => 'bid_update'));
...
Route::filter('before', function() {
  ...
  if (Auth::officer() && Auth::officer()->role == Officer::ROLE_NOT_APPROVED) {
    Auth::logout();
    return Redirect::to('/')->with('errors', array(__("r.flashes.account_not_approved")));
  }
});
