...
Class Factory {
  ...
  public static function vendor() {
    ...
    $v = new Vendor(array('name' => $faker->name,
                          ...
                          'gender' => self::$agencies[array_rand(self::$agencies)],
                          'race_1' => (rand(1,2,3) > 1) ? self::$races[array_rand(self::$races)] : null,
                          'race_2' => (rand(1,2,3) == 1) ? self::$races[array_rand(self::$races)] : null
                          ));
