...
Rfpez.Backbone.BidView = Backbone.View.extend({
  ...
  toggleInterview: function() {
    return this.model.save({
      interview: this.model.attributes.interview === "1" ? "0" : "1"
    });
  },
...
Rfpez.demographic_stats = function(stats) {
  ...
  return Raphael.g.axis(120, 153, 165, null, null, 6, 1, stats.raceLabels.reverse(), "|", 0, raceChart);
};
